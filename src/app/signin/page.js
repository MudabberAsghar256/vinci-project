        ...
        <div className="w-full ">
          <form className="rounded mb-4">
            <div className="mb-1">
              ...
              <input
                className="shadow appearance-none p-3 pt-2 required rounded w-full px-3 bg-white text-gray-700 mb-3"
                required
                id="Email"
                type="text"
            ...
            <div className="mb-2">
              ...
              <input
                className="shadow appearance-none rounded w-full p-3 px-3 bg-white text-gray-700 mb-2"
                required
                id="password"
                type="password"

...
export default function Pracitice() {
  return (
    <div className="w-full min-h-screen bg-[#FAF6F3]">
      <div>
        <div className="h-full flex justify-center items-center min-h-screen mx-auto p-4 ">
          <div className="bg-[rgb(232,233,228)] bg-opacity-100 rounded-md px-8 md:px-20 py-10 w-[650px] shadow-md shadow-black/10 p-4  ">
            <div className="flex flex-col items-center justify-center">
              ...
              <div className=" justify-center items-center text-center">
                <h1 className="text-[24px] font-[500] text-black">Welcome</h1>
                <p className="text-center font-[400] text-black">
                  Chart AI generates ready to bill SOAP notes and codes at your
                  point of care.
                </p>
              </div>
              ...
              <p className="text-center font-[400] text-[14px] text-black">
                Already have an account?
                <Link href="/signin">
                  <span className="font-[500] text-primary cursor-pointer text-[#4A703E]">
                    Sign In
                  </span>
                </Link>
              </p>
